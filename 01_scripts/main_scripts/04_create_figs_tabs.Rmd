...
![Figure 1 : Occurrences et fréquences relatives des espèces](../03_figs/hist_freq.png)


![Figure 2 : Abondance et richesse spécifique au sein des placettes forestières](../03_figs/nb_sp_nb_ind.png)
...
![Figure 3 : Distribution des classes d'abondance au sein des placettes forestières](../03_figs/classes_abondance.png)


## Transformation des données d'arbres

![Figure 4 : Diagramme de boîte à moustaches des abondances transformées de l'espèce la plus commune, Betula papyrifera](../03_figs/transfo.png)
...
![3comm](../03_figs/carte_liens3_logchord.png)![4comm](../03_figs/carte_liens4_logchord.png)

![Figure 5 : Groupements en 3, 4 et 5 communautés écoforestières](../03_figs/carte_liens5_logchord.png)

## Ordination simple (analyse en composantes principales)

![Figure 6 : Analyse en composantes principales, cadrage 1](../03_figs/ACP_3comm.png)

## Ordination canonique (analyse de redondance)
```{r tableau selection variables, echo=FALSE}
var_seliables <- read.csv("../02_outdata/var_sel.csv") %>%
  rename(`Variables` = "variables",
         `Ordre` = "order",
         `R2 cumulé` = "R2Cum",
         `R2 ajusté cumulé` = "AdjR2Cum",
         `p-value` = "pvalue",)
knitr::kable(var_seliables,
...
![Figure A1 : Fréquences relatives des espèces au sein des communautés, pour trois communautés](../03_figs/graph_comm3.png)

![Figure A2 : Fréquences relatives des espèces au sein des communautés, pour quatre communautés](../03_figs/graph_comm4.png)


![Figure A3 : Fréquences relatives des espèces au sein des communautés, pour cinq communautés](../03_figs/graph_comm5.png)

![Figure A4 : Distribution des communautés écoforestières](../03_figs/carte_3comm.png)

![Figure A5 : Analyse de redondance. a: cadrage 1; b: cadrage 2. Fitted site scores (lc scores).](../03_figs/RDA_triplot.rda.lc.png)
