...
The standard p<0.05 criteria was used to determine if the permutational tests suggested that the results were significantly different from those expected if the null hypothesis were correct. Permutational tests were performed using 999 permutations.
...
=======
![Location of the study area. a : Boundary map of the Station de biologie des Laurentides. The orange rectangle targets zones 1, 2 and 3. b: Map of all three zones. The brown rectangle targets zone 1. c: Part of the tree crown polygons annotated in *ArcGIS Pro*.](../03_figs/FigureA2.png)
>>>>>>> 78ec4fb19183461b9e28c23d5c80adbf0d8ae6e9
